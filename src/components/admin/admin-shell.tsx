...
function mapAuthUserToAppUser(u: {
  uid: string;
  email: string | null;
...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  const getPageTitle = () => {
    ...
    if (pathname?.startsWith("/admin/campanas")) return "Campañas certificadas";
    ...
    if (pathname === "/admin/marketing/linkedin/campanas/nueva") return "Nueva campaña LinkedIn";
    if (pathname?.startsWith("/admin/marketing/linkedin/campanas/")) return "Campaña LinkedIn";
    if (pathname?.startsWith("/admin/marketing/linkedin/campanas")) return "Campañas LinkedIn";
    if (pathname === "/admin/marketing/campanas/nueva") return "Nueva campaña email";
    if (pathname?.startsWith("/admin/marketing/campanas/")) return "Campaña email";
    if (pathname?.startsWith("/admin/marketing/campanas")) return "Campañas email";
