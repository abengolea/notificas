...
- Preserve country, industry and use-case taxonomy. Use the fixed catalog keys (seguros, gas, carteras_credito, aviso_corte, cesion_credito). Never invent a rubro from a CSV or from a use-case name. Industry and use-case are separate.
